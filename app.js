...
Tu \xE9s Dom Bosco n\xF3s somos os teus queridos jovens amados.
                                                ...
                                                11`}],S={async get(o){try{const{data:e}=await SB.from("missa_kv").select("value").eq("key",o).maybeSingle();return e?e.value:null}catch(e){return console.error(e),null}},async set(o,e){try{return await SB.from("missa_kv").upsert({key:o,value:e,updated_at:new Date().toISOString()}),!0}catch(n){return console.error(n),!1}}},uid=o=>(o||"u")+Date.now().toString(36)+Math.random().toString(36).slice(2,6),norm=o=>(o||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),nt=o=>norm(o).replace(/[^a-z0-9 ]+/g," ").replace(/\s+/g," ").trim(),driveEmbed=o=>{const e=(o||"").match(/\/d\/([A-Za-z0-9_-]+)/);return e?`https://drive.google.com/file/d/${e[1]}/preview`:o};function ymd(o){const e=o.getFullYear(),n=String(o.getMonth()+1).padStart(2,"0"),u=String(o.getDate()).padStart(2,"0");return`${e}-${n}-${u}`}function parseYmd(o){const[e,n,u]=o.split("-").map(Number);return new Date(e,n-1,u)}function startOfWeek(o){const e=new Date(o);e.setHours(0,0,0,0);const n=(e.getDay()+6)%7;return e.setDate(e.getDate()-n),e}function fmtDiaCurto(o){return`${DOW_NOME[o.getDay()].slice(0,3)} ${String(o.getDate()).padStart(2,"0")}/${String(o.getMonth()+1).padStart(2,"0")}`}function fmtDiaLongo(o){return`${DOW_NOME[o.getDay()]}, ${String(o.getDate()).padStart(2,"0")}/${String(o.getMonth()+1).padStart(2,"0")}/${o.getFullYear()}`}const SH=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],ENH={Db:"C#",Eb:"D#",Gb:"F#",Ab:"G#",Bb:"A#",Cb:"B",Fb:"E","E#":"F","B#":"C"};function shiftRoot(o,e){let n=ENH[o]||o,u=SH.indexOf(n);return u<0?o:SH[((u+e)%12+12)%12]}const CH_RE=/^([A-G](?:#|b)?)((?:maj|min|sus|add|dim|aug|m|M|°|º|\+|\d|\(|\)|b|#|\.)*)(?:\/([A-G](?:#|b)?))?$/;function isChordToken(o){return o?!!o.match(CH_RE):!1}function transposeToken(o,e){const n=o.match(CH_RE);if(!n)return o;let u=shiftRoot(n[1],e)+(n[2]||"");return n[3]&&(u+="/"+shiftRoot(n[3],e)),u}function isChordLine(o){const e=o.trim().split(/\s+/).filter(Boolean);return e.length?e.filter(isChordToken).length/e.length>=.6:!1}function transposeText(o,e){return!e||!o?o:o.split(`
`).map(n=>isChordLine(n)?n.replace(/\S+/g,u=>isChordToken(u)?transposeToken(u,e):u):n).join(`
`)}function App(){const[o,e]=useState(!0),[n,u]=useState("repertorio"),[t,h]=useState({}),[E,f]=useState([]),[r,v]=useState(DEFAULT_TEAMS),[p,m]=useState({}),[A,i]=useState({font:17}),[l,D]=useState(null),[c,b]=useState(null),[x,M]=useState(null),[q,B]=useState(null),[a,G]=useState(null),[F,O]=useState(null),[N,w]=useState(null),[R,I]=useState(()=>{try{return localStorage.getItem("mt_editor")==="1"}catch(s){return!1}}),[$,P]=useState(!1),U=useRef({}),y=useCallback(async()=>{const[s,d,k,H,ro,mo,to]=await Promise.all([S.get("mt_over"),S.get("mt_added"),S.get("mt_teams"),S.get("mt_masses"),S.get("mt_settings"),S.get("mt_seedV"),S.get("mt_pin")]);mo!==SEED_VERSION&&await S.set("mt_seedV",SEED_VERSION),h(s||{}),f(d||[]),v(k&&k.length?k:DEFAULT_TEAMS),m(H||{}),i(z({font:17},ro||{})),w(to||null),e(!1)},[]);useEffect(()=>{y();const s=SB.channel("missa_kv_rt").on("postgres_changes",{event:"*",schema:"public",table:"missa_kv"},()=>y()).subscribe();return()=>{try{SB.removeChannel(s)}catch(d){}}},[y]);const L=(s,d,k)=>{k(d),U.current[s]&&clearTimeout(U.current[s]),U.current[s]=setTimeout(()=>S.set(s,d),600)},Q=s=>L("mt_over",s,h),V=s=>L("mt_added",s,f),oo=s=>L("mt_teams",s,v),eo=s=>L("mt_masses",s,m),J=s=>L("mt_settings",s,i),j=useMemo(()=>SEED_SONGS.filter(d=>!(t[d.id]&&t[d.id].hidden)).map(d=>z(z({},d),t[d.id]||{})).concat(E),[t,E]),T=useMemo(()=>{const s={};return j.forEach(d=>s[d.id]=d),s},[j]),_=s=>{const d=T[s];d&&(d.cifra?D(s):d.u?B({url:d.u,title:(d.n!=null?d.n+" \xB7 ":"")+d.t}):D(s))},ao=(s,d)=>{const k=(s||[]).filter(H=>T[H]);k.length&&b({ids:k,i:Math.max(0,Math.min(d||0,k.length-1))})},Z=(s,d)=>{s.startsWith("u")?V(E.map(k=>k.id===s?z(z({},k),d):k)):Q(g(z({},t),{[s]:z(z({},t[s]||{}),d)}))},no=s=>{const d=z({id:uid("u"),src:"Adicionada"},s);return V([...E,d]),d.id},Ao=s=>{s.startsWith("u")?V(E.filter(d=>d.id!==s)):Q(g(z({},t),{[s]:g(z({},t[s]||{}),{hidden:!0})}))},so=s=>{const d=(s||"").trim();if(!N){if(d.length<4)return"Defina uma senha com ao menos 4 d\xEDgitos.";S.set("mt_pin",d),w(d),I(!0);try{localStorage.setItem("mt_editor","1")}catch(k){}return""}if(d===N){I(!0);try{localStorage.setItem("mt_editor","1")}catch(k){}return""}return"Senha incorreta."},W=()=>{I(!1);try{localStorage.removeItem("mt_editor")}catch(s){}};return o?React.createElement("div",{style:{background:C.bg,color:C.txt},className:"min-h-screen flex items-center justify-center p-6"},React.createElement("div",{className:"text-center"},React.createElement("div",{style:{background:"#fff"},className:"rounded-2xl p-3 mb-4 inline-block shadow-lg"},React.createElement("img",{src:"church.png",alt:"Par\xF3quia Santa Teresinha",style:{maxWidth:300,width:"72vw"}})),React.createElement("p",{style:{color:C.mut},className:"flex items-center justify-center gap-2"},React.createElement(Music,{size:18,style:{color:C.gold},className:"animate-pulse"})," Carregando o repert\xF3rio\u2026"))):React.createElement("div",{style:{background:C.bg,color:C.txt,minHeight:"100vh",fontFamily:"system-ui, sans-serif"}},React.createElement("div",{style:{background:`linear-gradient(135deg, ${C.card2}, ${C.card})`,borderBottom:`1px solid ${C.line}`},className:"px-4 pt-4 pb-3 sticky top-0 z-20"},React.createElement("div",{className:"flex items-center gap-2"},React.createElement("div",{style:{background:"#fff"},className:"rounded-lg px-1.5 py-1 shrink-0"},React.createElement("img",{src:"church.png",alt:"Par\xF3quia Santa Teresinha",style:{height:30}})),React.createElement("div",{className:"leading-tight"},React.createElement("h1",{className:"font-bold"},"Repert\xF3rio da Missa"),React.createElement("p",{className:"text-xs",style:{color:C.mut}},"Santa Teresinha \xB7 ",j.length," m\xFAsicas")),React.createElement("button",{onClick:()=>R?W():P(!0),title:R?"Sair do modo edi\xE7\xE3o":"Entrar no modo edi\xE7\xE3o",style:{background:C.card2,color:R?C.gold:C.mut,marginLeft:"auto"},className:"px-2.5 py-2 rounded-lg flex items-center gap-1 text-xs shrink-0"},R?React.createElement(Unlock,{size:15}):React.createElement(Lock,{size:15}),R?React.createElement("span",null,"edi\xE7\xE3o"):null))),React.createElement("div",{className:"p-3 pb-24 max-w-2xl mx-auto"},n==="repertorio"&&React.createElement(Repertorio,{songs:j,onPlay:_,onAdd:no,onEdit:s=>O(s),onVideo:s=>G({url:s.yt,title:(s.n!=null?s.n+" \xB7 ":"")+s.t}),editor:R}),n==="missas"&&React.createElement(Missas,{masses:p,teams:r,songById:T,onOpen:s=>M(s)}),n==="equipes"&&React.createElement(Equipes,{teams:r,saveTeams:oo,masses:p,editor:R,onOpenLock:()=>P(!0)}),n==="ajustes"&&React.createElement(Ajustes,{settings:A,saveSettings:J,songs:j,editor:R,hasPin:!!N,pin:N,onLock:W,onOpenLock:()=>P(!0),savePin:s=>{S.set("mt_pin",s),w(s)}})),React.createElement("nav",{style:{background:C.card,borderTop:`1px solid ${C.line}`},className:"fixed bottom-0 left-0 right-0 z-20"},React.createElement("div",{className:"max-w-2xl mx-auto grid grid-cols-4"},[{k:"repertorio",ic:Music,lb:"Repert\xF3rio"},{k:"missas",ic:Calendar,lb:"Missas"},{k:"equipes",ic:Users,lb:"Equipes"},{k:"ajustes",ic:Settings,lb:"Ajustes"}].map(({k:s,ic:d,lb:k})=>React.createElement("button",{key:s,onClick:()=>u(s),className:"py-2.5 flex flex-col items-center gap-0.5",style:{color:n===s?C.gold:C.mut}},React.createElement(d,{size:20}),React.createElement("span",{style:{fontSize:10.5}},k))))),(l||c)&&React.createElement(Player,{song:c?T[c.ids[c.i]]:T[l],playlist:c?c.ids:null,index:c?c.i:0,onNav:s=>b(d=>d&&g(z({},d),{i:Math.max(0,Math.min(s,d.ids.length-1))})),settings:A,saveSettings:J,updateSong:Z,openViewer:(s,d)=>B({url:s,title:d}),editor:R,onClose:()=>{c?b(null):D(null)}}),q&&React.createElement(PdfViewer,{url:q.url,title:q.title,onClose:()=>B(null)}),a&&React.createElement(VideoViewer,{url:a.url,title:a.title,onClose:()=>G(null)}),F&&React.createElement(AddSong,{initial:F,onClose:()=>O(null),onSave:s=>{Z(F.id,s),O(null)}}),$&&React.createElement(LockModal,{hasPin:!!N,onClose:()=>P(!1),onSubmit:s=>so(s)}),x&&React.createElement(MassEditor,{mkey:x,masses:p,saveMasses:eo,teams:r,songs:j,songById:T,onPlay:_,onShow:ao,onVideo:s=>G({url:s.yt,title:s.t}),onEdit:s=>O(s),editor:R,onClose:()=>M(null)}))}function Repertorio({songs:o,onPlay:e,onAdd:n,onEdit:u,onVideo:t,editor:h}){const[E,f]=useState(""),[r,v]=useState("Todos"),[p,m]=useState("Todas"),[A,i]=useState(!1),l=useMemo(()=>["Todas",...Array.from(new Set(o.map(c=>c.src)))],[o]),D=useMemo(()=>{const c=nt(E),b=c.split(" ").filter(Boolean),x=E.replace(/\D/g,"");let M=o.filter(q=>{if(r!=="Todos"&&q.m!==r||p!=="Todas"&&q.src!==p)return!1;if(!b.length&&!x)return!0;const B=nt(q.t),a=b.length>0&&b.every(F=>B.includes(F)),G=x!==""&&q.n!=null&&String(q.n).includes(x);return a||G});if(b.length||x){const q=B=>{const a=nt(B.t);return x&&String(B.n)===x?0:a===c?1:c&&a.startsWith(c)?2:b[0]&&a.startsWith(b[0])?3:c&&a.includes(c)?4:5};M=M.slice().sort((B,a)=>q(B)-q(a)||B.t.localeCompare(a.t,"pt"))}return M.slice(0,200)},[o,E,r,p]);return React.createElement("div",null,React.createElement("div",{className:"relative mb-2"},React.createElement(Search,{size:16,style:{color:C.mut},className:"absolute left-3 top-1/2 -translate-y-1/2"}),React.createElement("input",{value:E,onChange:c=>f(c.target.value),placeholder:"Buscar por t\xEDtulo ou n\xBA\u2026",style:{background:C.card,border:`1px solid ${C.line}`,color:C.txt},className:"w-full pl-9 pr-3 py-2.5 rounded-xl outline-none"})),React.createElement("div",{className:"flex gap-2 overflow-x-auto pb-2"},React.createElement(Sel,{value:r,onChange:v,options:["Todos",...MOMENTOS]}),React.createElement(Sel,{value:p,onChange:m,options:l}),h&&React.createElement("button",{onClick:()=>i(!0),style:{background:C.gold,color:"#2b2100"},className:"px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap flex items-center gap-1"},React.createElement(Plus,{size:14})," Nova")),React.createElement("p",{className:"text-xs mb-2",style:{color:C.mut}},D.length," resultado(s)",D.length===400?"+ (refine a busca)":""),React.createElement("div",{className:"space-y-2"},D.map(c=>React.createElement(SongRow,{key:c.id,s:c,onPlay:e,onVideo:t,onEdit:u,editor:h}))),A&&React.createElement(AddSong,{onClose:()=>i(!1),onSave:c=>{n(c),i(!1)}}))}function SongRow({s:o,onPlay:e,onVideo:n,onEdit:u,editor:t}){return React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"w-full p-3 rounded-xl flex items-center gap-2"},React.createElement("button",{onClick:()=>e(o.id),className:"flex items-center gap-3 min-w-0 flex-1 text-left active:opacity-70"},React.createElement("div",{style:{background:C.card2,color:C.gold,minWidth:44},className:"px-2 py-1 rounded-lg text-center"},o.n!=null?React.createElement("span",{className:"font-bold text-sm"},o.n):React.createElement(Music,{size:16,className:"mx-auto"})),React.createElement("div",{className:"min-w-0 flex-1"},React.createElement("p",{className:"font-semibold truncate"},o.t),React.createElement("div",{className:"flex items-center gap-2 text-xs mt-0.5",style:{color:C.mut}},o.tom?React.createElement("span",{style:{color:C.violet}},"\u{1F3B5} ",o.tom):null,React.createElement("span",{style:{color:MOMENTO_COR[o.m]||C.mut}},o.m)))),o.yt?React.createElement("button",{onClick:()=>n(o),title:"Assistir v\xEDdeo",style:{background:C.card2,color:C.danger},className:"p-2 rounded-lg shrink-0"},React.createElement(Youtube,{size:18})):null,o.sp?React.createElement("a",{href:o.sp,target:"_blank",rel:"noreferrer",onClick:h=>h.stopPropagation(),title:"Ouvir no Spotify",style:{background:C.card2,color:C.green},className:"p-2 rounded-lg shrink-0"},React.createElement(Spotify,{size:18})):null,t?React.createElement("button",{onClick:()=>u(o),title:"Editar cadastro",style:{background:C.card2,color:C.gold},className:"p-2 rounded-lg shrink-0"},React.createElement(Pencil,{size:16})):null,React.createElement("button",{onClick:()=>e(o.id),title:"Abrir cifra",style:{color:C.gold},className:"p-1.5 shrink-0"},o.cifra?React.createElement(Play,{size:18}):React.createElement(FileText,{size:17,style:{color:C.blue}})))}function Sel({value:o,onChange:e,options:n}){return React.createElement("select",{value:o,onChange:u=>e(u.target.value),style:{background:C.card,border:`1px solid ${C.line}`,color:C.txt},className:"px-3 py-1.5 rounded-full text-xs outline-none max-w-[46%]"},n.map(u=>React.createElement("option",{key:u,value:u},u)))}function Player({song:o,settings:e,saveSettings:n,updateSong:u,openViewer:t,editor:h,onClose:E,playlist:f,index:r,onNav:v}){const[p,m]=useState(0),[A,i]=useState(0),[l,D]=useState(!1),[c,b]=useState(o?{tom:o.tom||"",m:o.m||"Geral",u:o.u||"",sp:o.sp||"",cifra:o.cifra||""}:{}),x=useRef(null),M=e.font||17;if(useEffect(()=>{m(0),i(0),D(!1),b({tom:(o==null?void 0:o.tom)||"",m:(o==null?void 0:o.m)||"Geral",u:(o==null?void 0:o.u)||"",sp:(o==null?void 0:o.sp)||"",cifra:(o==null?void 0:o.cifra)||""})},[o==null?void 0:o.id]),useEffect(()=>{if(!A||!x.current)return;const a=x.current,G=setInterval(()=>{a.scrollTop+=A},60);return()=>clearInterval(G)},[A]),useEffect(()=>{let a=null;const G=async()=>{try{navigator.wakeLock&&(a=await navigator.wakeLock.request("screen"))}catch(O){}};G();const F=()=>{document.visibilityState==="visible"&&G()};return document.addEventListener("visibilitychange",F),()=>{document.removeEventListener("visibilitychange",F);try{a&&a.release()}catch(O){}}},[]),!o)return null;const B=(o.cifra?transposeText(o.cifra,p):"").split(`
`);return React.createElement("div",{style:{background:C.bg,color:C.txt},className:"fixed inset-0 z-[60] flex flex-col"},React.createElement("div",{style:{background:C.card,borderBottom:`1px solid ${C.line}`},className:"px-3 py-2 flex items-center gap-2 sticky top-0"},React.createElement("button",{onClick:E,style:{background:C.card2,color:C.txt},className:"px-3 py-2 rounded-lg flex items-center gap-1 font-semibold shrink-0"},React.createElement(ChevronLeft,{size:18})," Voltar"),React.createElement("div",{className:"min-w-0 flex-1"},React.createElement("p",{className:"font-bold truncate"},o.n!=null?o.n+" \xB7 ":"",o.t),React.createElement("p",{className:"text-xs truncate",style:{color:C.mut}},o.src,o.tom?" \xB7 tom original "+o.tom:"")),f&&f.length>1?React.createElement("div",{className:"flex items-center gap-1 shrink-0"},React.createElement("button",{onClick:()=>v(r-1),disabled:r<=0,style:{background:C.card2,opacity:r<=0?.4:1},className:"p-2 rounded-lg"},React.createElement(ChevronLeft,{size:16})),React.createElement("span",{className:"text-xs font-semibold text-center",style:{color:C.mut,minWidth:36}},r+1,"/",f.length),React.createElement("button",{onClick:()=>v(r+1),disabled:r>=f.length-1,style:{background:C.card2,opacity:r>=f.length-1?.4:1},className:"p-2 rounded-lg"},React.createElement(ChevronRight,{size:16}))):null,h?React.createElement("button",{onClick:()=>D(a=>!a),style:{background:C.card2,color:l?C.gold:C.txt},className:"p-2 rounded-lg"},React.createElement(Pencil,{size:16})):null),React.createElement("div",{style:{background:C.card2,borderBottom:`1px solid ${C.line}`},className:"px-3 py-2 flex items-center gap-2 flex-wrap text-xs"},React.createElement("div",{className:"flex items-center gap-1"},React.createElement("span",{style:{color:C.mut}},"Tom"),React.createElement("button",{onClick:()=>m(a=>a-1),style:{background:C.card},className:"p-1.5 rounded-lg"},React.createElement(Minus,{size:14})),React.createElement("span",{style:{color:C.gold,minWidth:26},className:"text-center font-bold"},p>0?"+"+p:p),React.createElement("button",{onClick:()=>m(a=>a+1),style:{background:C.card},className:"p-1.5 rounded-lg"},React.createElement(Plus,{size:14}))),React.createElement("div",{className:"flex items-center gap-1"},React.createElement(Type,{size:13,style:{color:C.mut}}),React.createElement("button",{onClick:()=>n(g(z({},e),{font:Math.max(12,M-1)})),style:{background:C.card},className:"p-1.5 rounded-lg"},React.createElement(Minus,{size:14})),React.createElement("span",{style:{minWidth:22},className:"text-center"},M),React.createElement("button",{onClick:()=>n(g(z({},e),{font:Math.min(30,M+1)})),style:{background:C.card},className:"p-1.5 rounded-lg"},React.createElement(Plus,{size:14}))),React.createElement("div",{className:"flex items-center gap-1"},React.createElement("button",{onClick:()=>i(a=>a>0?0:1),style:{background:A?C.gold:C.card,color:A?"#2b2100":C.txt},className:"p-1.5 rounded-lg flex items-center gap-1"},A?React.createElement(Pause,{size:14}):React.createElement(Play,{size:14}),React.createElement("span",null,"rolar")),A>0&&React.createElement("input",{type:"range",min:"1",max:"5",value:A,onChange:a=>i(Number(a.target.value)),className:"w-16"})),React.createElement("div",{className:"ml-auto flex items-center gap-2"},o.sp?React.createElement("a",{href:o.sp,target:"_blank",rel:"noreferrer",title:"Ouvir no Spotify",style:{background:C.green,color:"#04261b"},className:"px-2.5 py-1.5 rounded-lg font-semibold flex items-center gap-1"},React.createElement(Spotify,{size:14})," Spotify"):null,o.u?React.createElement("button",{onClick:()=>t(o.u,o.t),style:{background:C.blue,color:"#04203f"},className:"px-2.5 py-1.5 rounded-lg font-semibold flex items-center gap-1"},React.createElement(FileText,{size:13})," Ver cifra"):null)),l?React.createElement("div",{className:"p-3 overflow-y-auto flex-1 space-y-3"},React.createElement("p",{className:"text-sm font-semibold",style:{color:C.gold}},"Editar m\xFAsica"),React.createElement(Field,{label:"Tom"},React.createElement("input",{value:c.tom,onChange:a=>b(g(z({},c),{tom:a.target.value})),placeholder:"ex.: Sol Maior / G",style:inp})),React.createElement(Field,{label:"Momento da missa"},React.createElement("select",{value:c.m,onChange:a=>b(g(z({},c),{m:a.target.value})),style:inp},MOMENTOS.map(a=>React.createElement("option",{key:a},a)))),React.createElement(Field,{label:"Link (Drive/YouTube) \u2014 opcional"},React.createElement("input",{value:c.u,onChange:a=>b(g(z({},c),{u:a.target.value})),placeholder:"https://\u2026",style:inp})),React.createElement(Field,{label:"Link do Spotify \u2014 opcional"},React.createElement("input",{value:c.sp||"",onChange:a=>b(g(z({},c),{sp:a.target.value})),placeholder:"https://open.spotify.com/track/\u2026",style:inp})),React.createElement(Field,{label:"Cifra em texto (acordes + letra) \u2014 habilita transpor/rolar"},React.createElement("textarea",{value:c.cifra,onChange:a=>b(g(z({},c),{cifra:a.target.value})),rows:10,wrap:"off",placeholder:`Cole aqui a cifra. Ex.:
   C        G
Vem, Esp\xEDrito Santo\u2026`,style:g(z({},inp),{fontFamily:"ui-monospace, monospace",whiteSpace:"pre",overflowX:"auto"})})),React.createElement("div",{className:"flex gap-2"},React.createElement("button",{onClick:()=>{u(o.id,c),D(!1)},style:{background:C.green,color:"#04261b"},className:"flex-1 py-2.5 rounded-xl font-semibold flex items-center justify-center gap-1"},React.createElement(Save,{size:16})," Salvar"),React.createElement("button",{onClick:()=>D(!1),style:{background:C.card2,color:C.mut},className:"px-4 rounded-xl"},"Cancelar"))):React.createElement("div",{ref:x,className:"flex-1 px-3 py-3",style:{overflow:"auto",scrollBehavior:"smooth",WebkitOverflowScrolling:"touch"}},o.cifra?React.createElement("pre",{style:{fontFamily:"ui-monospace, SFMono-Regular, Menlo, monospace",fontSize:M,lineHeight:1.5,whiteSpace:"pre",display:"inline-block",minWidth:"100%"}},B.map((a,G)=>isChordLine(a)?React.createElement("div",{key:G,style:{color:C.gold,fontWeight:700}},a||"\xA0"):React.createElement("div",{key:G},a||"\xA0"))):o.u?React.createElement("div",{className:"text-center py-6"},React.createElement(FileText,{size:42,style:{color:C.blue},className:"mx-auto mb-3"}),React.createElement("p",{className:"mb-3",style:{color:C.mut}},"A cifra desta m\xFAsica est\xE1 em PDF no Drive."),React.createElement("button",{onClick:()=>t(o.u,o.t),style:{background:C.blue,color:"#04203f"},className:"inline-flex items-center gap-2 px-4 py-2.5 rounded-xl font-semibold"},React.createElement(FileText,{size:16})," Ver cifra (PDF)"),React.createElement("p",{className:"mt-4 text-xs",style:{color:C.mut}},"Dica: toque no l\xE1pis \u270F\uFE0F acima para colar a cifra em texto e habilitar transpor/rolagem.")):React.createElement("div",{className:"text-center py-6"},React.createElement(ListMusic,{size:42,style:{color:C.mut},className:"mx-auto mb-3"}),React.createElement("p",{className:"mb-3",style:{color:C.mut}},"Ainda sem cifra cadastrada."),h?React.createElement("button",{onClick:()=>D(!0),style:{background:C.gold,color:"#2b2100"},className:"inline-flex items-center gap-2 px-4 py-2.5 rounded-xl font-semibold"},React.createElement(Pencil,{size:16})," Colar cifra ou link"):React.createElement("p",{className:"text-xs",style:{color:C.mut}},"Entre no modo edi\xE7\xE3o (cadeado no topo) para adicionar a cifra."))))}function Missas({masses:o,teams:e,songById:n,onOpen:u}){const[t,h]=useState(()=>startOfWeek(new Date)),E=useMemo(()=>Array.from({length:7},(p,m)=>{const A=new Date(t);return A.setDate(t.getDate()+m),A}),[t]),f=useMemo(()=>{const p={};return e.forEach(m=>p[m.id]=m),p},[e]),r=p=>{const m=new Date(t);m.setDate(t.getDate()+p*7),h(m)},v=ymd(new Date);return React.createElement("div",null,React.createElement("div",{className:"flex items-center justify-between mb-3"},React.createElement("button",{onClick:()=>r(-1),style:{background:C.card},className:"p-2 rounded-lg"},React.createElement(ChevronLeft,{size:18})),React.createElement("div",{className:"text-center"},React.createElement("p",{className:"text-xs",style:{color:C.mut}},"Semana de"),React.createElement("p",{className:"font-semibold text-sm"},fmtDiaCurto(E[0])," \u2014 ",fmtDiaCurto(E[6]))),React.createElement("button",{onClick:()=>r(1),style:{background:C.card},className:"p-2 rounded-lg"},React.createElement(ChevronRight,{size:18}))),React.createElement("button",{onClick:()=>h(startOfWeek(new Date)),style:{color:C.gold},className:"text-xs mb-3 underline"},"Voltar para esta semana"),E.map(p=>{const m=SLOTS_DOW[p.getDay()]||[],A=ymd(p)===v;return React.createElement("div",{key:ymd(p),className:"mb-4"},React.createElement("h2",{className:"font-bold text-sm mb-2 flex items-center gap-2",style:{color:A?C.gold:C.txt}},fmtDiaLongo(p)," ",A&&React.createElement("span",{style:{background:C.gold,color:"#2b2100"},className:"px-2 py-0.5 rounded-full text-[10px]"},"hoje")),React.createElement("div",{className:"space-y-2"},m.map(i=>{const l=ymd(p)+"|"+i,D=o[l],c=D&&D.team?f[D.team]:null,b=D&&D.songs?D.songs.length:0;return React.createElement("button",{key:i,onClick:()=>u(l),style:{background:C.card,border:`1px solid ${c?c.color:C.line}`},className:"w-full text-left p-3 rounded-xl flex items-center gap-3 active:opacity-70"},React.createElement("div",{style:{background:C.card2,color:C.gold,minWidth:56},className:"px-2 py-1.5 rounded-lg text-center font-bold text-sm"},i),React.createElement("div",{className:"min-w-0 flex-1"},c?React.createElement("p",{className:"font-semibold truncate",style:{color:c.color}},c.name):React.createElement("p",{style:{color:C.mut}},"Sem equipe definida"),React.createElement("p",{className:"text-xs",style:{color:C.mut}},b>0?b+" m\xFAsica(s) no repert\xF3rio":"toque para montar a missa")),React.createElement(ChevronRight,{size:18,style:{color:C.mut}}))})))}))}function MassEditor({mkey:o,masses:e,saveMasses:n,teams:u,songs:t,songById:h,onPlay:E,onShow:f,onVideo:r,onEdit:v,editor:p,onClose:m}){const[A,i]=o.split("|"),l=e[o]||{team:"",songs:[],note:""},[D,c]=useState(!1),b=a=>n(g(z({},e),{[o]:z(z({},l),a)})),x=(l.songs||[]).map(a=>h[a]).filter(Boolean),M=x.map(a=>a.id),q=(a,G)=>{const F=[...l.songs],O=a+G;O<0||O>=F.length||([F[a],F[O]]=[F[O],F[a]],b({songs:F}))},B=a=>b({songs:l.songs.filter((G,F)=>F!==a)});return React.createElement("div",{style:{background:C.bg,color:C.txt},className:"fixed inset-0 z-40 flex flex-col"},React.createElement("div",{style:{background:C.card,borderBottom:`1px solid ${C.line}`},className:"px-3 py-2 flex items-center gap-2 sticky top-0"},React.createElement("button",{onClick:m,style:{background:C.card2,color:C.txt},className:"px-3 py-2 rounded-lg flex items-center gap-1 font-semibold shrink-0"},React.createElement(ChevronLeft,{size:18})," Voltar"),React.createElement("div",null,React.createElement("p",{className:"font-bold"},fmtDiaLongo(parseYmd(A))),React.createElement("p",{className:"text-xs",style:{color:C.mut}},"Missa das ",i))),React.createElement("div",{className:"overflow-y-auto flex-1 p-3 space-y-4"},React.createElement(Field,{label:"Equipe que vai tocar"},React.createElement("select",{value:l.team||"",onChange:a=>b({team:a.target.value}),style:inp},React.createElement("option",{value:""},"\u2014 escolher equipe \u2014"),u.map(a=>React.createElement("option",{key:a.id,value:a.id},a.name)))),React.createElement("div",null,React.createElement("div",{className:"flex items-center justify-between mb-2"},React.createElement("p",{className:"font-semibold text-sm",style:{color:C.gold}},"Repert\xF3rio (",x.length,")"),React.createElement("div",{className:"flex items-center gap-2"},x.length>0?React.createElement("button",{onClick:()=>f(M,0),style:{background:C.green,color:"#04261b"},className:"px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1"},React.createElement(Play,{size:14})," Modo Show"):null,React.createElement("button",{onClick:()=>c(!0),style:{background:C.gold,color:"#2b2100"},className:"px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1"},React.createElement(Plus,{size:14})," Adicionar m\xFAsica"))),x.length===0&&React.createElement("p",{className:"text-xs",style:{color:C.mut}},'Nenhuma m\xFAsica ainda. Toque em "Adicionar m\xFAsica".'),React.createElement("div",{className:"space-y-2"},x.map((a,G)=>React.createElement("div",{key:a.id+G,style:{background:C.card,border:`1px solid ${C.line}`},className:"p-2.5 rounded-xl flex items-center gap-2"},React.createElement("div",{className:"flex flex-col"},React.createElement("button",{onClick:()=>q(G,-1),style:{color:C.mut},className:"p-0.5"},React.createElement(ArrowUp,{size:14})),React.createElement("button",{onClick:()=>q(G,1),style:{color:C.mut},className:"p-0.5"},React.createElement(ArrowDown,{size:14}))),React.createElement("button",{onClick:()=>f(M,G),className:"min-w-0 flex-1 text-left"},React.createElement("p",{className:"font-medium truncate text-sm"},a.t),React.createElement("p",{className:"text-xs",style:{color:C.mut}},a.tom?a.tom+" \xB7 ":"",React.createElement("span",{style:{color:MOMENTO_COR[a.m]}},a.m))),a.yt?React.createElement("button",{onClick:()=>r(a),title:"V\xEDdeo",style:{color:C.danger},className:"p-1.5"},React.createElement(Youtube,{size:16})):null,a.sp?React.createElement("a",{href:a.sp,target:"_blank",rel:"noreferrer",title:"Spotify",style:{color:C.green},className:"p-1.5"},React.createElement(Spotify,{size:15})):null,p?React.createElement("button",{onClick:()=>v(a),title:"Editar",style:{color:C.gold},className:"p-1.5"},React.createElement(Pencil,{size:15})):null,React.createElement("button",{onClick:()=>B(G),title:"Remover",style:{color:C.danger},className:"p-1.5"},React.createElement(Trash2,{size:15})))))),React.createElement(Field,{label:"Observa\xE7\xF5es (leitura, tom especial, solista\u2026)"},React.createElement("textarea",{value:l.note||"",onChange:a=>b({note:a.target.value}),rows:3,style:inp,placeholder:"Anota\xE7\xF5es da missa\u2026"})),React.createElement("button",{onClick:m,style:{background:C.green,color:"#04261b"},className:"w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 active:opacity-80"},React.createElement(Check,{size:18})," Concluir \u2014 repert\xF3rio salvo"),React.createElement("p",{className:"text-xs text-center",style:{color:C.mut}},"Tudo \xE9 salvo automaticamente e fica vis\xEDvel para a equipe. Toque numa m\xFAsica para abrir a cifra.")),D&&React.createElement(SongPicker,{songs:t,onClose:()=>c(!1),onPick:a=>{b({songs:[...l.songs||[],a]})}}))}function SongPicker({songs:o,onClose:e,onPick:n}){const[u,t]=useState(""),[h,E]=useState("Todos"),f=useMemo(()=>{const r=nt(u),v=r.split(" ").filter(Boolean),p=u.replace(/\D/g,"");let m=o.filter(A=>{if(!(h==="Todos"||A.m===h))return!1;if(!v.length&&!p)return!0;const i=nt(A.t);return v.length>0&&v.every(l=>i.includes(l))||p!==""&&A.n!=null&&String(A.n).includes(p)});if(v.length||p){const A=i=>{const l=nt(i.t);return p&&String(i.n)===p?0:l===r?1:r&&l.startsWith(r)?2:v[0]&&l.startsWith(v[0])?3:4};m=m.slice().sort((i,l)=>A(i)-A(l)||i.t.localeCompare(l.t,"pt"))}return m.slice(0,200)},[o,u,h]);return React.createElement("div",{style:{background:"rgba(0,0,0,0.6)"},className:"fixed inset-0 z-50 flex items-end sm:items-center justify-center"},React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"w-full max-w-lg rounded-t-2xl sm:rounded-2xl max-h-[85vh] flex flex-col"},React.createElement("div",{className:"p-3 border-b",style:{borderColor:C.line}},React.createElement("div",{className:"flex items-center justify-between mb-2"},React.createElement("p",{className:"font-semibold"},"Adicionar m\xFAsica"),React.createElement("button",{onClick:e},React.createElement(X,{size:18,style:{color:C.mut}}))),React.createElement("input",{value:u,onChange:r=>t(r.target.value),placeholder:"Buscar\u2026",style:inp,autoFocus:!0}),React.createElement("div",{className:"mt-2"},React.createElement(Sel,{value:h,onChange:E,options:["Todos",...MOMENTOS]}))),React.createElement("div",{className:"overflow-y-auto p-2 space-y-1"},f.map(r=>React.createElement("button",{key:r.id,onClick:()=>{n(r.id),e()},style:{background:C.card2},className:"w-full text-left p-2.5 rounded-lg flex items-center gap-2 active:opacity-70"},React.createElement("span",{style:{color:C.gold,minWidth:34},className:"text-xs font-bold text-center"},r.n!=null?r.n:"\u266A"),React.createElement("span",{className:"min-w-0 flex-1 truncate text-sm"},r.t),React.createElement("span",{className:"text-xs",style:{color:MOMENTO_COR[r.m]}},r.m))))))}function Equipes({teams:o,saveTeams:e,masses:n,editor:u,onOpenLock:t}){const[h,E]=useState(""),f=useMemo(()=>{const i={};return Object.values(n).forEach(l=>{l.team&&(i[l.team]=(i[l.team]||0)+1)}),i},[n]),r=[C.rose,C.violet,C.green,C.gold,C.blue,C.danger],v=()=>{const i=h.trim();i&&(e([...o,{id:uid("t"),name:i,color:r[o.length%r.length]}]),E(""))},p=(i,l)=>e(o.map(D=>D.id===i?g(z({},D),{name:l}):D)),m=i=>e(o.map(l=>l.id===i?g(z({},l),{color:r[(r.indexOf(l.color)+1)%r.length]}):l)),A=i=>e(o.filter(l=>l.id!==i));return u?React.createElement("div",null,React.createElement("p",{className:"text-sm mb-3",style:{color:C.mut}},"Cadastre as equipes/minist\xE9rios de m\xFAsica. Depois \xE9 s\xF3 escalar cada equipe nas missas da semana."),React.createElement("div",{className:"flex gap-2 mb-4"},React.createElement("input",{value:h,onChange:i=>E(i.target.value),onKeyDown:i=>i.key==="Enter"&&v(),placeholder:"Nome da equipe",style:inp}),React.createElement("button",{onClick:v,style:{background:C.gold,color:"#2b2100"},className:"px-4 rounded-xl font-semibold"},"Add")),React.createElement("div",{className:"space-y-2"},o.map(i=>React.createElement("div",{key:i.id,style:{background:C.card,border:`1px solid ${C.line}`},className:"p-3 rounded-xl flex items-center gap-3"},React.createElement("button",{onClick:()=>m(i.id),style:{background:i.color,minWidth:18,height:18},className:"rounded-full shrink-0",title:"trocar cor"}),React.createElement("input",{value:i.name,onChange:l=>p(i.id,l.target.value),style:{background:"transparent",color:C.txt},className:"flex-1 outline-none font-medium"}),React.createElement("span",{className:"text-xs",style:{color:C.mut}},f[i.id]||0," missa(s)"),React.createElement("button",{onClick:()=>A(i.id),style:{color:C.danger}},React.createElement(Trash2,{size:16})))))):React.createElement("div",null,React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"rounded-xl p-3 mb-3 flex items-center gap-2"},React.createElement(Lock,{size:16,style:{color:C.gold}}),React.createElement("p",{className:"text-xs flex-1",style:{color:C.mut}},"Para criar ou editar equipes, entre no modo edi\xE7\xE3o."),React.createElement("button",{onClick:t,style:{background:C.gold,color:"#2b2100"},className:"px-3 py-1.5 rounded-full text-xs font-semibold shrink-0"},"Entrar")),React.createElement("div",{className:"space-y-2"},o.map(i=>React.createElement("div",{key:i.id,style:{background:C.card,border:`1px solid ${C.line}`},className:"p-3 rounded-xl flex items-center gap-3"},React.createElement("span",{style:{background:i.color,minWidth:18,height:18},className:"rounded-full inline-block shrink-0"}),React.createElement("span",{className:"flex-1 font-medium"},i.name),React.createElement("span",{className:"text-xs",style:{color:C.mut}},f[i.id]||0," missa(s)")))))}function Ajustes({settings:o,saveSettings:e,songs:n,editor:u,hasPin:t,pin:h,onLock:E,onOpenLock:f,savePin:r}){const v=n.filter(m=>m.u).length,p=n.filter(m=>m.cifra).length;return React.createElement("div",{className:"space-y-4"},React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"rounded-xl p-4 space-y-2"},React.createElement("p",{className:"font-semibold",style:{color:C.gold}},"Senha de edi\xE7\xE3o"),u?React.createElement(React.Fragment,null,React.createElement("p",{className:"text-sm",style:{color:C.green}},"\u2713 Modo edi\xE7\xE3o ativo neste aparelho."),React.createElement(PinChange,{hasPin:t,pin:h,savePin:r}),React.createElement("button",{onClick:E,style:{background:C.card2,color:C.txt},className:"px-3 py-2 rounded-lg text-sm flex items-center gap-1"},React.createElement(Lock,{size:14})," Sair do modo edi\xE7\xE3o")):React.createElement(React.Fragment,null,React.createElement("p",{className:"text-sm",style:{color:C.mut}},t?"Apenas quem tem a senha pode editar m\xFAsicas e equipes.":"Defina uma senha para liberar a edi\xE7\xE3o de m\xFAsicas e equipes."),React.createElement("button",{onClick:f,style:{background:C.gold,color:"#2b2100"},className:"px-3 py-2 rounded-lg text-sm font-semibold flex items-center gap-1"},React.createElement(Unlock,{size:14})," ",t?"Entrar no modo edi\xE7\xE3o":"Criar senha de edi\xE7\xE3o"))),React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"rounded-xl p-4"},React.createElement("p",{className:"font-semibold mb-1",style:{color:C.gold}},"Sobre o repert\xF3rio"),React.createElement("p",{className:"text-sm",style:{color:C.mut}},n.length," m\xFAsicas no total \xB7 ",v," com PDF \xB7 ",p," com cifra em texto (transp\xF5e)."),React.createElement("p",{className:"text-xs mt-2",style:{color:C.mut}},"Fontes: ",React.createElement("b",null,"Louvemos o Senhor")," (livro cifrado, n\xBA 1\u20131172), ",React.createElement("b",null,"Cifras PDF"),", ",React.createElement("b",null,"Santa Teresinha")," e ",React.createElement("b",null,"Dom Bosco")," (Google Drive da par\xF3quia).")),React.createElement(Field,{label:`Tamanho padr\xE3o da letra: ${o.font||17}px`},React.createElement("input",{type:"range",min:"12",max:"30",value:o.font||17,onChange:m=>e(g(z({},o),{font:Number(m.target.value)})),className:"w-full"})),React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"rounded-xl p-4 text-sm"},React.createElement("p",{className:"font-semibold mb-1",style:{color:C.gold}},"Pasta de cifras no Drive"),React.createElement("a",{href:"https://drive.google.com/drive/folders/12s0xc-gpn0EP4SIAizsmxFc4LWNOhfxc",target:"_blank",rel:"noreferrer",style:{color:C.blue},className:"inline-flex items-center gap-1 underline"},React.createElement(ExternalLink,{size:14}),' Abrir "M\xFAsicas da igreja"')),React.createElement("p",{className:"text-xs text-center",style:{color:C.mut}},"Tudo o que voc\xEA edita aqui \xE9 compartilhado com a equipe em tempo real."))}function PinChange({hasPin:o,pin:e,savePin:n}){const[u,t]=useState(!1),[h,E]=useState(""),[f,r]=useState(""),[v,p]=useState("");if(!u)return React.createElement("button",{onClick:()=>t(!0),style:{color:C.blue},className:"text-sm underline block"},"Alterar senha");const m=()=>{if(o&&h.trim()!==e){p("Senha atual incorreta.");return}if(f.trim().length<4){p("A nova senha precisa de ao menos 4 d\xEDgitos.");return}n(f.trim()),p("Senha atualizada \u2713"),E(""),r(""),setTimeout(()=>t(!1),1e3)};return React.createElement("div",{className:"space-y-2"},o?React.createElement("input",{value:h,onChange:A=>E(A.target.value),type:"password",inputMode:"numeric",placeholder:"Senha atual",style:inp}):null,React.createElement("input",{value:f,onChange:A=>r(A.target.value),type:"password",inputMode:"numeric",placeholder:"Nova senha (m\xEDn. 4 d\xEDgitos)",style:inp}),v?React.createElement("p",{className:"text-xs",style:{color:v.indexOf("\u2713")>=0?C.green:C.danger}},v):null,React.createElement("div",{className:"flex gap-2"},React.createElement("button",{onClick:m,style:{background:C.green,color:"#04261b"},className:"px-3 py-1.5 rounded-lg text-sm font-semibold"},"Salvar senha"),React.createElement("button",{onClick:()=>{t(!1),p("")},style:{background:C.card2,color:C.mut},className:"px-3 py-1.5 rounded-lg text-sm"},"Cancelar")))}const inp={background:C.bg,border:`1px solid ${C.line}`,color:C.txt,borderRadius:12,padding:"10px 12px",outline:"none",width:"100%"};function Field({label:o,children:e}){return React.createElement("label",{className:"block"},React.createElement("span",{className:"text-xs block mb-1",style:{color:C.mut}},o),e)}function AddSong({onClose:o,onSave:e,initial:n}){const u=!!n,[t,h]=useState(n?{t:n.t||"",n:n.n!=null?String(n.n):"",tom:n.tom||"",m:n.m||"Geral",u:n.u||"",yt:n.yt||"",cifra:n.cifra||""}:{t:"",n:"",tom:"",m:"Geral",u:"",yt:"",cifra:""}),[E,f]=useState(""),r=(m,A)=>h(i=>g(z({},i),{[m]:A})),v=async m=>{const A=m.target.files&&m.target.files[0];if(A){if(A.type&&A.type.indexOf("pdf")<0){f("Selecione um arquivo PDF.");return}f("Enviando\u2026");try{const i=(A.name||"musica.pdf").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^A-Za-z0-9._-]+/g,"_"),l="up-"+Date.now().toString(36)+"-"+i,{error:D}=await SB.storage.from("uploads").upload(l,A,{upsert:!0,contentType:"application/pdf"});if(D){f("Falha no upload: "+D.message);return}const{data:c}=SB.storage.from("uploads").getPublicUrl(l);r("u",c.publicUrl),f("PDF enviado \u2713")}catch(i){f("Falha no upload.")}}},p=()=>{if(!t.t.trim())return;const m={t:t.t.trim(),tom:t.tom.trim(),m:t.m,u:t.u.trim(),yt:t.yt.trim(),cifra:t.cifra};t.n&&/^\d+$/.test(t.n)?m.n=Number(t.n):u&&!t.n&&(m.n=null),e(m)};return React.createElement("div",{style:{background:"rgba(0,0,0,0.6)"},className:"fixed inset-0 z-50 flex items-end sm:items-center justify-center"},React.createElement("div",{style:{background:C.card,border:`1px solid ${C.line}`},className:"w-full max-w-lg rounded-t-2xl sm:rounded-2xl max-h-[90vh] overflow-y-auto p-4 space-y-3"},React.createElement("div",{className:"flex items-center justify-between"},React.createElement("p",{className:"font-semibold",style:{color:C.gold}},u?"Editar m\xFAsica":"Nova m\xFAsica"),React.createElement("button",{onClick:o},React.createElement(X,{size:18,style:{color:C.mut}}))),React.createElement(Field,{label:"T\xEDtulo *"},React.createElement("input",{value:t.t,onChange:m=>r("t",m.target.value),style:inp,autoFocus:!0})),React.createElement("div",{className:"flex gap-2"},React.createElement(Field,{label:"N\xBA (opcional)"},React.createElement("input",{value:t.n,onChange:m=>r("n",m.target.value),style:inp,inputMode:"numeric"})),React.createElement(Field,{label:"Tom"},React.createElement("input",{value:t.tom,onChange:m=>r("tom",m.target.value),placeholder:"G / Sol",style:inp}))),React.createElement(Field,{label:"Momento da missa"},React.createElement("select",{value:t.m,onChange:m=>r("m",m.target.value),style:inp},MOMENTOS.map(m=>React.createElement("option",{key:m},m)))),React.createElement(Field,{label:"Link da cifra (PDF/Drive) \u2014 opcional"},React.createElement("input",{value:t.u,onChange:m=>r("u",m.target.value),placeholder:"https://\u2026",style:inp})),React.createElement("div",null,React.createElement("label",{style:{background:C.card2,color:C.txt,border:"1px dashed "+C.line},className:"flex items-center justify-center gap-2 py-2.5 rounded-xl cursor-pointer text-sm font-medium"},React.createElement(Upload,{size:16})," Enviar PDF da m\xFAsica",React.createElement("input",{type:"file",accept:"application/pdf",onChange:v,className:"hidden"})),E?React.createElement("p",{className:"text-xs mt-1",style:{color:E.indexOf("\u2713")>=0?C.green:E.indexOf("Enviando")>=0?C.mut:C.danger}},E):null),React.createElement(Field,{label:"Link do YouTube (bot\xE3o de v\xEDdeo) \u2014 opcional"},React.createElement("input",{value:t.yt,onChange:m=>r("yt",m.target.value),placeholder:"https://youtu.be/\u2026",style:inp})),React.createElement(Field,{label:"Cifra em texto (opcional \u2014 habilita transpor/rolar)"},React.createElement("textarea",{value:t.cifra,onChange:m=>r("cifra",m.target.value),rows:6,wrap:"off",style:g(z({},inp),{fontFamily:"ui-monospace, monospace",whiteSpace:"pre",overflowX:"auto"})})),React.createElement("button",{onClick:p,style:{background:C.green,color:"#04261b"},className:"w-full py-2.5 rounded-xl font-semibold flex items-center justify-center gap-1"},React.createElement(Check,{size:16})," ",u?"Salvar altera\xE7\xF5es":"Salvar m\xFAsica")))}function PdfViewer({url:o,title:e,onClose:n}){const u=driveEmbed(o);return React.createElement("div",{style:{background:"rgba(0,0,0,0.92)"},className:"fixed inset-0 z-[60] flex flex-col"},React.createElement("div",{style:{background:C.card,borderBottom:"1px solid "+C.line},className:"px-3 py-2 flex items-center gap-2"},React.createElement("button",{onClick:n,style:{background:C.card2,color:C.txt},className:"px-3 py-2 rounded-lg flex items-center gap-1 font-semibold shrink-0"},React.createElement(ChevronLeft,{size:18})," Voltar"),React.createElement("p",{className:"font-semibold truncate flex-1"},e),React.createElement("a",{href:o,target:"_blank",rel:"noreferrer",style:{color:C.blue},className:"text-xs flex items-center gap-1 shrink-0"},React.createElement(ExternalLink,{size:13})," nova aba")),React.createElement("iframe",{title:e,src:u,className:"flex-1 w-full",style:{border:0,background:"#fff"},allow:"autoplay"}))}function VideoViewer({url:o,title:e,onClose:n}){const u=String(o||"").match(/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|embed\/|shorts\/|live\/)|[?&]v=)([A-Za-z0-9_-]{6,})/),t=u?u[1]:"",h=t?"https://www.youtube.com/embed/"+t+"?rel=0&playsinline=1":"";return React.createElement("div",{style:{background:"rgba(0,0,0,0.92)"},className:"fixed inset-0 z-[60] flex flex-col"},React.createElement("div",{style:{background:C.card,borderBottom:"1px solid "+C.line},className:"px-3 py-2 flex items-center gap-2"},React.createElement("button",{onClick:n,style:{background:C.card2,color:C.txt},className:"px-3 py-2 rounded-lg flex items-center gap-1 font-semibold shrink-0"},React.createElement(ChevronLeft,{size:18})," Voltar"),React.createElement("p",{className:"font-semibold truncate flex-1"},e),React.createElement("a",{href:o,target:"_blank",rel:"noreferrer",style:{color:C.blue},className:"text-xs flex items-center gap-1 shrink-0"},React.createElement(ExternalLink,{size:13})," YouTube")),React.createElement("div",{className:"flex-1 flex items-center justify-center p-2"},h?React.createElement("div",{style:{position:"relative",width:"100%",maxWidth:900,aspectRatio:"16 / 9"}},React.createElement("iframe",{title:e,src:h,style:{border:0,width:"100%",height:"100%",borderRadius:12},allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0})):React.createElement("p",{style:{color:C.mut}},"Link de v\xEDdeo inv\xE1lido. ",React.createElement("a",{href:o,target:"_blank",rel:"noreferrer",style:{color:C.blue},className:"underline"},"Abrir link"))))}function LockModal({hasPin:o,onClose:e,onSubmit:n}){const[u,t]=useState(""),[h,E]=useState(""),f=()=>{const r=n(u);r?E(r):e()};return React.createElement("div",{style:{background:"rgba(0,0,0,0.6)"},className:"fixed inset-0 z-[70] flex items-end sm:items-center justify-center"},React.createElement("div",{style:{background:C.card,border:"1px solid "+C.line},className:"w-full max-w-sm rounded-t-2xl sm:rounded-2xl p-4 space-y-3"},React.createElement("div",{className:"flex items-center justify-between"},React.createElement("p",{className:"font-semibold",style:{color:C.gold}},o?"Modo edi\xE7\xE3o":"Criar senha de edi\xE7\xE3o"),React.createElement("button",{onClick:e},React.createElement(X,{size:18,style:{color:C.mut}}))),React.createElement("p",{className:"text-xs",style:{color:C.mut}},o?"Digite a senha para editar m\xFAsicas e equipes neste aparelho.":"Defina uma senha (m\xEDn. 4 d\xEDgitos). Quem tiver a senha poder\xE1 editar o repert\xF3rio e as equipes."),React.createElement("input",{value:u,onChange:r=>{t(r.target.value),E("")},onKeyDown:r=>r.key==="Enter"&&f(),type:"password",inputMode:"numeric",placeholder:o?"Senha":"Nova senha",style:inp,autoFocus:!0}),h?React.createElement("p",{className:"text-xs",style:{color:C.danger}},h):null,React.createElement("button",{onClick:f,style:{background:C.gold,color:"#2b2100"},className:"w-full py-2.5 rounded-xl font-semibold flex items-center justify-center gap-1"},React.createElement(Unlock,{size:16})," ",o?"Entrar":"Criar e entrar")))}const _root=ReactDOM.createRoot(document.getElementById("root"));_root.render(React.createElement(App,null));try{window.__booted=!0}catch(o){}
